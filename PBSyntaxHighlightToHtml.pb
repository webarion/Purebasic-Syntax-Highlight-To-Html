...
Procedure.s Load_INI_File_SHL( PathFile$, Section$ )
  ...
  SHL_Template("LabelColor")         = ReadPreferenceString( "LabelColor",         "<b><font color='#D33682'>%1</font></b>" )
  SHL_Template("NumberColor")        = ReadPreferenceString( "NumberColor",        "<b><font color='#FF628C'>%1</font></b>" )
  SHL_Template("StringColor")        = ReadPreferenceString( "StringColor",        "<b><font color='#3AD900'>%1</font></b>" )
  SHL_Template("ModuleColor")        = ReadPreferenceString( "ModuleColor",        "<b><font color='#CB4B16'>%1</font></b>" )
  SHL_Template("PointerColor")       = ReadPreferenceString( "PointerColor",       "<b><font color='#5DAEF2'>%1</font></b>" )
  SHL_Template("CommentColor")       = ReadPreferenceString( "CommentColor",       "<b><font color='#0088FF'>%1</font></b>" )
  SHL_Template("ConstantColor")      = ReadPreferenceString( "ConstantColor",      "<b><font color='#FF628C'>%1</font></b>" )
  SHL_Template("OperatorColor")      = ReadPreferenceString( "OperatorColor",      "<b><font color='#FF9D00'>%1</font></b>" )
  SHL_Template("SeparatorColor")     = ReadPreferenceString( "SeparatorColor",     "<b><font color='#FFD715'>%1</font></b>" )
  SHL_Template("StructureColor")     = ReadPreferenceString( "StructureColor",     "<b><font color='#60B66D'>%1</font></b>" )
  SHL_Template("ASMKeywordColor")    = ReadPreferenceString( "ASMKeywordColor",    "<b><font color='#6C71C4'>%1</font></b>" ) 
  SHL_Template("PureKeywordColor")   = ReadPreferenceString( "PureKeywordColor",   "<b><font color='#FFB454'>%1</font></b>" )
  SHL_Template("BasicKeywordColor")  = ReadPreferenceString( "BasicKeywordColor",  "<b><font color='#FFB054'>%1</font></b>" )
  SHL_Template("CustomKeywordColor") = ReadPreferenceString( "CustomKeywordColor", "<b><font color='#FB86CD'>%1</font></b>" )
